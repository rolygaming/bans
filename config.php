...
define('DB_HOST', '45.235.98.65');   			// The host/ip to your SQL server
define('DB_USER', 'alejandrol_5264');					// The username to connect with
define('DB_PASS', 'JA38!k3cbeT5');						// The password
define('DB_NAME', 'alejandrol_sourceban');  			// Database name	
